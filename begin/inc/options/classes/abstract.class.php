 ...
 *
 */
if ( ! class_exists( 'ZMOP_Abstract' ) ) {
  abstract class ZMOP_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        ZMOP::$css = apply_filters( "zmop_{$this->unique}_output_css", ZMOP::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'ZMOP_Field_' . $field_type;
