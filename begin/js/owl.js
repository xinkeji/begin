...
jQuery(document).ready(function($){
	$('.lazy-img, .group-lazy-img').owlCarousel({
		items: 1,
	});

	var owl_time = Timeout.owl_time;
	$('.slider-home, .slider-group').owlCarousel({
		items: 1,
		lazyLoad: true,
		loop: true,
		nav: true,
	...
	function resetProgressBar() {
		$(".slide-progress").removeClass("planned");
		$(".slide-progress").addClass("again");
	}

	var flexisel_f = flexiselitems.flexisel_f;
	$('.slider-rolling').owlCarousel({
		lazyLoad: true,
		margin: 5,
		nav: true,
		navText: ["<i class='bz be be-arrowleft'></i>", "<i class='bz be be-arrowright'></i>"],
	...
	$('.grid-carousel').owlCarousel({
		...
		responsive: {
			...
			1000 : {
				items: grid_carousel_f
			}
		}
	});

	$('.placardtxt').owlCarousel({
		items: 1,
		lazyLoad: true,
		loop: true,
		nav: true,
