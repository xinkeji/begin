...
//Browser caching
if (! defined('BROWSER_CACHE_MAX_AGE') )         define ('BROWSER_CACHE_MAX_AGE', 604800);
	...
	public function __construct(){
		...
		if ($this->isURL){
			if (ALLOW_ALL_EXTERNAL_SITES){
				...
				if (! $allowed){
					return $this->error("Need to add external picture domain name!");
				}
			}
		}
