...
function baidu_record_t() {
	if (is_user_logged_in()) {
		if (baidu_check(get_permalink()) == 1) {
			echo '<li class="baidu-r"><a target="_blank" title="点击查看" rel="external nofollow" href="http://www.baidu.com/s?wd='.get_the_title().'&tn=bds&cl=3&ct=2097152&si=' . $_SERVER['SERVER_NAME']. '&s=on"><i class="be be-baidu"></i>已收录</a></li>';
		} else {
