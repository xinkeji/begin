...
jQuery(document).ready(function($) {
	...
	$('.to-down').click(function() {
		$('html,body').animate({
			scrollTop: $('.zmop-footer').offset().top
		},
		500);
	});

	$('.to-up').mouseover(function() {
		$('html,body').animate({
	...
	$(".zmop-expand-shut").click(function() {
		if($(this).hasClass('add')) {
			$('.zmop-tab-item').addClass('zmop-tab-expanded');
			$(this).removeClass('add').addClass('remove');
		} else {
			$('.zmop-tab-item').removeClass('zmop-tab-expanded');
			$(this).removeClass('remove').addClass('add');
		}
	});

	$(".zmop-expand-all").click(function() {
		$('.be-box').toggleClass('zmop-shut-all');
	});

	$(window).scroll(function(){
		if($(window).scrollTop() >= 1){
			$(".zmop-header-inner").addClass('zmop-header-down');
		} else{
			$(".zmop-header-inner").removeClass('zmop-header-down');
		}
	});
});